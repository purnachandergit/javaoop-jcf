...
//		response.setContentType("text/html"); //MIME type ,output type of engine which is handed over to browser
//		//"application/ms-word" this is output then it hands over to support type in os
//		PrintWriter out=response.getWriter(); //for character stream
//		//ServletOutputStream out=response.getOutputStream(); //for byte stream like images
//		out.print("<html><body>");
